...
void OpticFlow::onInit() {
  ...
  // HARDCODE CAMERA PARAMETERS START
  ///////////////////////////////////
  fx_ = 477.78586954352323;
  fy_ = 480.6678820118329;
  cx_ = 322.72767560819693;
  cy_ = 258.974159781733;
  k1_ = 0.11906203790630414;
  k2_ = -0.23224501485827584;
  p1_ = 0.002897948377514225;
  p2_ = -0.0026544348133675866;
  k3_ = 0;
  ...
  // HARDCODE CAMERA PARAMETERS END
  ///////////////////////////////////
  ...
  subscriber_image_          = nh_.subscribe("/camera/orthogonal", 1, &OpticFlow::callbackImage, this, ros::TransportHints().tcpNoDelay());
  subscriber_uav_height_ = nh_.subscribe("/drone/height_estimate", 1, &OpticFlow::callbackHeight, this, ros::TransportHints().tcpNoDelay());
  nrep_                  = 0;
...
void OpticFlow::callbackHeight(const std_msgs::Float64::ConstPtr &msg) {

  if (!is_initialized_)
    return;

  if (absf(msg->data) < 0.001) {
    return;
  }
